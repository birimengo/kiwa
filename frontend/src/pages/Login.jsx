...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Check if there's a pending action (like add to cart)
      const pendingAction = localStorage.getItem('pendingAction');
      if (pendingAction) {
        localStorage.removeItem('pendingAction');
        // You can handle the pending action here if needed
      }
      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          ...
          <p className="mt-2 text-center text-sm theme-text-muted">
            Or{' '}
            <Link to="/register" className="font-medium theme-primary-text hover:opacity-80">
